...
S01_MusicSelection::S01_MusicSelection()
{
}
...
void S01_MusicSelection::exit()
{
	m_Plane.move(0.f, 700.f, 0.f);
	m_Sphere.move(0.f, 500.f, 0.f);
}

void S01_MusicSelection::reset()
{

}

void S01_MusicSelection::render()
{
	m_Camera.ready();
...
void S01_MusicSelection::reshape(int w, int h)
{

}

void S01_MusicSelection::keyboard(int key, bool pressed, int x, int y, bool special)
{
	if (pressed)
	{
		switch (key)
...
void S01_MusicSelection::mouse(int button, bool pressed, int x, int y)
{
}

void S01_MusicSelection::motion(bool pressed, int x, int y)
{
	if (s)
...
void S01_MusicSelection::update(float fDeltaTime)
{
