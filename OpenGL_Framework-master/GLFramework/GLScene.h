...
public:
	...
	void print(std::string str, float x, float y, float z, float r, float g, float b) const; // for debugging purposes only
	void print(std::string str, float x, float y, float z, float r, float g, float b, float a) const;
